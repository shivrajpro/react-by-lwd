...
function SignUp(props) {
  ...
  return (
    <div className="flex justify-center my-5">
      ...
      {props.errorMsg && (
        <div className="p-2 bg-red-500 text-white">{props.errorMsg}</div>
      )}
      {props.successMsg && (
        <div className="p-2 bg-green-500 text-white">{props.successMsg}</div>
      )}
      <div>
        ...
        <form onSubmit={onSignUp}>
          ...
          <div>
            <button type="submit" className="p-2 my-2 text-white bg-green-500">
              SignUp
            </button>
          </div>
        </form>
